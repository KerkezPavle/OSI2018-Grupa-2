...
namespace GamePlay {
	...
	/// <summary>
	/// Summary for InfoAboutApp
	/// </summary>
	public ref class InfoAboutApp : public System::Windows::Forms::Form
	{
	public:
		InfoAboutApp(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ClientSize = System::Drawing::Size(497, 293);
			this->Controls->Add(this->label1);
			this->Name = L"InfoAboutApp";
			this->Text = L"InfoAboutApp";
